...
export const SCENARIOS: ScenarioConfig[] = [
  {
    ...
    truth: {
      ...
      location: { correct: "Queen St W & Bathurst", accept: ["queen", "bathurst"] },
      nature: { correct: "Assault", value: "Assault" },
      safe: { correct: "Yes", value: "yes" },
      count: { correct: "1", accept: ["1", "one"] },
      relationship: { correct: "Bystander", value: "Bystander" },
      suspect: { correct: "—", na: true },
      hazards: { correct: "Suspect at large / returning", accept: ["suspect", "attacker", "knife", "weapon", "return"] },
  ...
  },
  {
    ...
    truth: {
      callback: { correct: "—", na: true },
      location: { correct: "42 Sumach Street", accept: ["sumach", "42 sumach"] },
      nature: { correct: "Fire", value: "Fire" },
      safe: { correct: "No", value: "no" },
      count: { correct: "3", accept: ["3", "three"] },
      relationship: { correct: "Family", value: "Family" },
      suspect: { correct: "—", na: true },
      hazards: { correct: "Smoke / fire spreading", accept: ["smoke", "fire", "heat"] },
      special: { correct: "Two children downstairs", accept: ["child", "kid", "children"] },
    },
