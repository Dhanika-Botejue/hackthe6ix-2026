...
Either can be configured independently — e.g. real vitals with the scripted demo caller, or a real call with simulated vitals. Missing either key falls back cleanly to its sim path with no code changes needed.
